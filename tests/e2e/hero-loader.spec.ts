...
test("the opening signature appears once and hands off to the Hero", { tag: "@motion" }, async ({ page }) => {
  await page.goto("/");
...
test("the opening skips motion and fits on a reduced-motion phone", { tag: "@motion" }, async ({ page }) => {
