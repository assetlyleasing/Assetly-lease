...
At widths above 640px the full composition is shown. At 640px and below the approved production mode is **hidden**. Two code-ready alternatives — Access-only and Growth-only — are retained behind one typed setting and documented in `HERO_PLATE_MOBILE_OPTIONS.md`; neither is active without a future owner review. Viewports 520px high or less always hide the plate.
