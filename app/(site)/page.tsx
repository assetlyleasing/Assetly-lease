 ...
 * Homepage.
 *
 * The Hero (Phase 2), Compare (Phase 4), Why Us (Phase 5), and Sectors
 * (Phase 6) are real. The section below them is still a placeholder, kept so
 * every Nav and Footer anchor resolves to something in the document.
 *
