...
|---|---|---|
| `"hidden"` | No plate at widths up to 640px | Approved production default; the copy has the full frame |
...
1. Change `HERO_MOBILE_PLATE_MODE` to `"hidden"`, `"access"`, or `"growth"`.
...
fourth mode requires a new approved composition, corresponding SVG/CSS rules,
tests, and a decision record.
